...
if __name__ == "__main__":
    ...
    #FrozenTrial(number=723, value=0.0393611, datetime_start=datetime.datetime(2021, 2, 17, 9, 55, 35), datetime_complete=datetime.datetime(2021, 2, 17, 9, 58, 11), params={'activation_dec': 'tanh', 'activation_ode': 'tanh', 'batchsize': 0.475363, 'dropout_dec': 0.0426343, 'enctype': 'LSTM', 'latent_dim': 1.25001, 'lr': 0.003413, 'nhidden': 3.20563, 'num_odelayers': 2, 'rnn_nhidden_dec': 0.530377, 'rnn_nhidden_enc': 0.521115, 'scaling_ELBO': 0.828398, 's_dim_static': 4, 'z_dim_static': 6}
    nepochs = 218
    activation_dec = 'tanh'
    activation_ode = 'tanh'
    batchsize = (0.475363*75)/100
    dropout_dec = 0.0426343
    enctype = 'LSTM'
    latent_dim = 1.25001
    lr = 0.003413
    nhidden = 3.20563
    num_odelayers = 2
    rnn_nhidden_dec = 0.530377
    rnn_nhidden_enc = 0.521115
    scaling_ELBO = 0.828398
    s_dim_static = 4
    z_dim_static = 6
    ...
    torch.save({'Generation_values': xs_pos_prior,
                ...
                'varnamesstatic':varnamesstatic}
               ,train_dir + '/Generationprior_n2100_eps005_t10_normed.pth')
