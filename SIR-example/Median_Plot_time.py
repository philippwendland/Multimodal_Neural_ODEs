...
genpriornode_n3000_eps005_t10 = torch.load(node_dir+'/Generationprior_n3000_eps005_t10_normed.pth')

genpriornode_n3000_eps005_t5 = torch.load(node_dir+'/Generationprior_n3000_eps005_t5_normed.pth')

genpriornode_n3000_eps005_t100 = torch.load(node_dir+'/Generationprior_n3000_eps005_t100_normed.pth')

# genpriornode_n3000_eps2_t10 = torch.load(node_dir+'/Generationprior_n3000_eps2_t10.pth')

# genpriornode_n3000_eps05_t10 = torch.load(node_dir+'/Generationprior_n3000_eps05_t10.pth')

#genpriornode_n7000_eps1_t10 = torch.load(node_dir+'/Generationprior_n7000_eps1_t10.pth')

#genpriornode_n2100_eps1_t10 = torch.load(node_dir+'/Generationprior_n2100_eps1_t10.pth')
...
xs_pos_prior_n3000_eps005_t10 = genpriornode_n3000_eps005_t10['Generation_values'][:,:,:]*1000
ts_pos_prior_n3000_eps005_t10 = genpriornode_n3000_eps005_t10['Generation_time']
...
xs_pos_prior_n3000_eps005_t5 = genpriornode_n3000_eps005_t5['Generation_values'][:,:,:]*1000
ts_pos_prior_n3000_eps005_t5 = genpriornode_n3000_eps005_t5['Generation_time']
...
xs_pos_prior_n3000_eps005_t100 = genpriornode_n3000_eps005_t100['Generation_values'][:,:,:]*1000
ts_pos_prior_n3000_eps005_t100 = genpriornode_n3000_eps005_t100['Generation_time']
